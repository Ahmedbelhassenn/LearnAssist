...
import { BookOpen, LucideAngularModule, Mail, MapPin, Phone, Star } from 'lucide-angular';
...
@Component({
  ...
  styleUrl: './instructor-details-page.component.css'
})
export class InstructorDetailsPageComponent implements OnInit {
